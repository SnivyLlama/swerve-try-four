...
public final class Constants {
    ...
    // Gyroscope axes
    public static final IMUAxis kYawAxis = IMUAxis.kRoll;
    // the other two dont matter as much
    public static final IMUAxis kPitchAxis = IMUAxis.kYaw;
    public static final IMUAxis kRollAxis = IMUAxis.kPitch;
